    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        ...
        <div>
          <h3>For Startup</h3>
          <ul>
            <li><a href="https://forms.google.com/feature-startup" target="_blank" rel="noopener noreferrer">Feature your Startup</a></li>
            <li><a href="https://forms.google.com/submit-funding" target="_blank" rel="noopener noreferrer">Submit your Funding Round</a></li>
          </ul>
        </div>
        ...
        <div>
          <h3>For Events</h3>
          <ul>
            <li><a href="https://forms.google.com/submit-event" target="_blank" rel="noopener noreferrer">Submit your Event</a></li>
